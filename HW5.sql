...
CREATE TABLE city_codes(
	...
	CONSTRAINT fk_city_codes FOREIGN KEY (city_name, state_province_abr, country_code)
		REFERENCES cities(city_name, state_province_abr, country_code));

-- flights table
CREATE TABLE flights(
	origin_city_code VARCHAR(10) REFERENCES city_codes(city_code),
	dest_city_code VARCHAR(10) REFERENCES city_codes(city_code),
...
CREATE TABLE bookings(
	booking_id INT,
	city_code VARCHAR(10) REFERENCES city_codes(city_code),
	book_date DATE,
